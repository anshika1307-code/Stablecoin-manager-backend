...
async function main() {
  ...
  /**
   * IMPORTANT: Exchange rates explanation
   * 
   * Rate calculation: (amountIn * rate) / 10000 = amountOut
   * 
   * For tokens with SAME decimals (USDC/USDT both 6 decimals):
   * - 1:1 rate = 10000 (10000 basis points)
   * 
   * For tokens with DIFFERENT decimals:
   * Need to account for decimal difference!
   * 
   * Example: USDC (6 decimals) → WETH (18 decimals)
   * If 1 USDC = 0.0004 WETH (ETH = $2500)
   * - Input: 1 USDC = 1,000,000 (6 decimals)
   * - Output: 0.0004 WETH = 400,000,000,000,000 (18 decimals)
   * - Rate = (output * 10000) / input = (400,000,000,000,000 * 10000) / 1,000,000
   * - Rate = 4,000,000,000,000
   * 
   * Simplified: rate = 0.0004 * 10^12 * 10000 = 4,000,000,000,000
   */
